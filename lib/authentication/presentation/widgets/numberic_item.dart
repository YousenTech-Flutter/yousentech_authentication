  ...
  itemNumber({required dynamic data, IconData? iconData}) {
    ...
    return Container(
      ...
      decoration: ShapeDecoration(
        color:SharedPr.isDarkMode! ? Colors.white.withValues(alpha: 0.01):const Color(0xFFF6F6F6),
              ...
              : InkWell(
                ...
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      color:SharedPr.isDarkMode! ? Colors.white.withValues(alpha: 0.66) :const Color(0xFF2E2E2E),
