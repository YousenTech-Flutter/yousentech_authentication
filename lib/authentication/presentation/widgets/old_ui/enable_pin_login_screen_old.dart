...
//   if (!enable) {
//   LoginHelper.activatePinLogin(isSkipValidate: true, authenticationController: authenticationController, formKey: _formKey, pinCodeController: pinCodeController , errorMessage: errorMessage,countErrors: countErrors);
//   }
//   onPressed() async {
//     countErrors = 0;
//     LoginHelper.activatePinLogin(authenticationController: authenticationController, formKey: _formKey, pinCodeController: pinCodeController,errorMessage: errorMessage , countErrors: countErrors);
//   }
